...
const file_rpc_create_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB.Z,github.com/noueii/gonuxt-starter/internal/pbb\x06proto3"
...
func file_rpc_create_user_proto_init() {
	...
	file_rpc_create_user_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
